...
func (transaction *Transaction) Cancel(dbw *DBW) {
	transaction.State = "cancelled"
	dbw.Conn.Save(transaction)
}

func NewestPendingTransactionForUser(dbw *DBW, user *User, txType string) (*Transaction, error) {
